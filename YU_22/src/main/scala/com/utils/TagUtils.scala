...
def getOneUserId(row:Row):String={
  row match {
    ...
    case v if StringUtils.isNotBlank(v.getAs[String]("openudidmd5")) => "OPM: "+v.getAs[String]("openudidmd5")
    case v if StringUtils.isNotBlank(v.getAs[String]("androididmd5")) => "ANM: "+v.getAs[String]("androididmd5")
    ...
    case v if StringUtils.isNotBlank(v.getAs[String]("openudidsha1")) => "OPS: "+v.getAs[String]("openudidsha1")
    case v if StringUtils.isNotBlank(v.getAs[String]("androididsha1")) => "ANS: "+v.getAs[String]("androididsha1")
